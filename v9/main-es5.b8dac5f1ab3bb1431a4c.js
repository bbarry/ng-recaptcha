...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppExamplesV3V3DemoComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function RecaptchaV3DemoComponent_h3_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function RecaptchaV3DemoComponent_pre_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function RecaptchaV3DemoComponent_h3_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function RecaptchaV3DemoComponent_pre_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function RecaptchaV3DemoComponent_ol_12_li_1_ng_template_5_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var entry_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function RecaptchaV3DemoComponent_ol_12_li_1_ng_template_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var RecaptchaV3DemoComponent = /*#__PURE__*/function () {
      ...
      _createClass(RecaptchaV3DemoComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.allExecutionErrorsSubscription = this.recaptchaV3Service.onExecuteError.subscribe(function (data) {
            return _this2.executionLog.push(data);
          });
        }
      }, {
    ...
    RecaptchaV3DemoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 13,
      vars: 6,
      consts: [[3, "click"], [4, "ngIf"], ["class", "error", 4, "ngIf"], [1, "error"], [4, "ngFor", "ngForOf"], [3, "ngIf"]],
...
//# sourceMappingURL=main-es5.b8dac5f1ab3bb1431a4c.js.map